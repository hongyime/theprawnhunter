...
def test_chatwindow_uses_redacted_view():
    ...
    with open("frontend/components/ChatWindow.tsx") as f:
        content = f.read()
...
def test_auth_context_structure():
    ...
    with open("frontend/lib/auth.tsx") as f:
        content = f.read()
...
def test_layout_mounts_auth_provider():
    ...
    with open("frontend/app/layout.tsx") as f:
        content = f.read()
...
def test_signin_page_exists():
    ...
    with open("frontend/app/signin/page.tsx") as f:
        content = f.read()
...
def test_canonical_rls_mirrors_discovered_credentials_public_hardening():
    ...
    with open("database/rls_policies.sql") as f:
        content = f.read()
